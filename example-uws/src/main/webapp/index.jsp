...
-->
<head>
    <title>example-uws</title>
</head>
<body>

<%
String sname = request.getServerName();  
String async = request.getScheme() + "://" + sname + "/example-uws/async";
String sync = request.getScheme() + "://" + sname + "/example-uws/sync";
%>

<h1>example-uws: A Sample UWS Service </h1>

<p>
This is the sample <a href="http://www.ivoa.net/Documents/UWS/">UWS</a> service from the 
<a href="https://github.com/opencadc/">OpenCADC</a> project. This
application uses several components from OpenCADC: cadc-util, cadc-uws (base UWS library), 
cadc-uws-server (server-side UWS library), and example-uws (this app).
</p>
