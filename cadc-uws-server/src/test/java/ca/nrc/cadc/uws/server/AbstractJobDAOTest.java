...
//        log.debug("deleted jobs");
    ...
    @Test
    public void testPutGetMinimal() throws Exception {
    ...
    @Test
    public void testPutGetError() throws Exception {
        Job job, after, persisted;
    ...
    @Test
    public void testPutGetOwner() throws Exception {
        Job job, after, persisted;
    ...
    @Test
    public void testPutGetWithParameters() throws Exception {
        Job job, after, persisted;
...
//        }
    ...
    @Test
    public void testPutGetWithJobInfo() throws Exception {
        Job job, after, persisted;
        // valid
        job = createJob();
    ...
    @Test
    public void testPutGetWithResults() throws Exception {
    ...
    @Test
    public void testPutGetWithMixedParametersResults() throws Exception {
    ...
    @Test
    public void testPutListFilterPhase() throws Exception {
    ...
    @Test
    public void testPutListFilterAfter() throws Exception {
    ...
    @Test
    public void testPutListFilterLast() throws Exception {
    ...
    @Test
    public void testPhaseTransitionAllowed() throws Exception {
    ...
    @Test
    public void testPhaseTransitionFail() throws Exception {
    ...
    @Test
    public void testPhaseTransitionResults() throws Exception {
    ...
    @Test
    public void testPhaseTransitionError() throws Exception {
    ...
    private void compareJobs(String str, Job exp, Job act) {
        ...
        if (exp.getErrorSummary() == null) {
            ...
            Assert.assertEquals("error message", exp.getErrorSummary().getSummaryMessage(), act.getErrorSummary()
                                                                                               .getSummaryMessage());
            Assert.assertEquals("error type", exp.getErrorSummary().getErrorType(), act.getErrorSummary()
                                                                                       .getErrorType());
            Assert.assertEquals("error url", exp.getErrorSummary().getDocumentURL(), act.getErrorSummary()
                                                                                        .getDocumentURL());
        }
